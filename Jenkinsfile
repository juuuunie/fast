pipeline {
  ...
  environment {
        ...
        GIT_REPOSITORY_URL = 'https://github.com/juuuunie/fast'
        GIT_CREDENTIONALS_ID = 'git_cre'
        GIT_EMAIL = 'juuuueeun@gmail.com'
        GIT_NAME = 'juuuunie'
        GIT_REPOSITORY_DEP = 'git@github.com:juuuunie/deployment.git'
      

        // AWS ECR
        AWS_ECR_CREDENTIAL_ID = 'aws_cre'
        AWS_ECR_URI = '734793106345.dkr.ecr.ap-northeast-2.amazonaws.com'
